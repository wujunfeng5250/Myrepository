...
import com.hurricane.blog.utils.JWTUtils;
...
public class LoginServiceImpl implements LoginService {
    ...
    public SysUser checkToken(String token) {
        ...
        String userJson = redisTemplate.opsForValue().get("TOKEN_" + token);//解析成功的话则拿到userJson
        if (StringUtils.isBlank(userJson)){
            return null;
        }
        SysUser sysUser = JSON.parseObject(userJson, SysUser.class);//都成功的话那就解析Json
        return sysUser;
    }
